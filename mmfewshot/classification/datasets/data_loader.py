...
class DataLoader(Generic[T_co]):
    ...
    def __init__(self,
        ...
        torch.set_vital('Dataloader', 'enabled',
    ...
    def __setattr__(self, attr, val):
        if self.__initialized and attr in ('batch_size', 'batch_sampler',
                                           'sampler', 'drop_last', 'dataset',
                                           'persistent_workers'):
    ...
    def check_worker_number_rationality(self):
        ...
        def _create_warning_msg(num_worker_suggest, num_worker_created,
                                cpuset_checked):
            ...
            suggested_max_worker_msg = ((
                ...
                num_worker_suggest, ('' if cpuset_checked else
                                     ' (`cpuset` is not taken into account)')
        ...
        if max_num_worker_suggest is None:
            warnings.warn(
                _create_warning_msg(max_num_worker_suggest, self.num_workers,
                                    cpuset_checked))
            return
        ...
        for i in range(self._num_workers):
            ...
            w = multiprocessing_context.Process(
                ...
                args=(self._dataset_kind, self._dataset, index_queue,
                      ...
                      self._num_workers, self._persistent_workers))
            w.daemon = True
...
# (shell2) ./test_socket.py sock_tmp 1017 send
    ...
    def _mark_worker_as_unavailable(self, worker_id, shutdown=False):
        ...
        assert self._workers_status[worker_id] or (self._persistent_workers
                                                   and shutdown)
        ...
        if not self._shutdown:
            ...
            try:
                ...
                for worker_id in range(len(self._workers)):
                    ...
                    if self._persistent_workers or self._workers_status[
                            worker_id]:
